 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.languages.tracery.traceryLanguage.impl.startValueImpl#getInnards <em>Innards</em>}</li>
 * </ul>
 *
 * @generated
 */
public class startValueImpl extends MinimalEObjectImpl.Container implements startValue
{
  ...
  public EList<InnerStatement> getInnards()
  {
    if (innards == null)
    {
      innards = new EObjectContainmentEList<InnerStatement>(InnerStatement.class, this, TraceryLanguagePackage.START_VALUE__INNARDS);
    }
    return innards;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TraceryLanguagePackage.START_VALUE__INNARDS:
